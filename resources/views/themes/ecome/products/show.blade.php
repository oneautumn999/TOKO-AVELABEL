                    ...
                    <div class="product-select">
                        <form>
                            ...
                            <div class="form-group">
                                <h4>Size</h4>
                                {!! Form::select('size', $sizes , null, ['class' => 'select form-control', 'placeholder' => '- Please Select -']) !!}
                            </div>
                            <div class="select-option-part" style="margin-bottom: 10px">
                                <label>Color*</label>
                                {!! Form::select('color', $colors , null, ['class' => 'select form-control', 'placeholder' => '- Please Select -']) !!}
                            </div>
                            @endif
                            ...
                            <div class="quickview-plus-minus">
								...
								<div class="col-md-12" style="margin-bottom: 10px">
                                    <button type="submit" class="submit btn btn-primary btn-block">Add to Cart</button>
                                </div>
                                <div class="col-md-4">
